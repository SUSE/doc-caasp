...
In the Grafana web interface, navigate to menu:Manage Dashboards[] and click menu:Import[]. In the field menu:Import via grafana.com[], enter the dashboard ID `12219`, and click menu:Load[].
...
On the next page, in the dropdown menu labeled menu:Prometheus[], select `Prometheus` as the data source. Customize the dashboard name and UID to your preference. Then click menu:Import[].
