...
Please refererence to xref:trusted_server_certificate[] and xref:trusted_client_certificate[] on how to signed the trusted tiller and helm certificate.
...
Please refererence to xref:self_signed_server_certificate[] and xref:self_signed_client_certificate[] on how to signed the self-sigend tiller and helm certificate.
The server.conf for IP.1 is `127.0.0.1`.
