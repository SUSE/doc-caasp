...
An other possibility is to connect to the nodes through a bastion using skuba
directly. This means skuba does not have to be installed on the bastion which
will just be used to forward ssh connection. Like with the cluster nodes, the
