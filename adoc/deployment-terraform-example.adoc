...
your cluster unusable. You can add more packages but do not remove any of the
default packages listed.
<14> `authorized_keys`: List of ssh-public-keys that will be able to log into the
deployed machines.
...
// <9> `authorized_keys`: List of ssh-public-keys that will be able to log into the
// deployed machines.
