...
# if set, datastore_cluster to use in vSphere
vsphere_datastore_cluster = "" // <2>
...
# IMPORTANT: Replace these ntp servers with ones from your infrastructure
ntp_servers = [ // <16>
  "0.novell.pool.ntp.org", "1.novell.pool.ntp.org", "2.novell.pool.ntp.org", "3.novell.pool.ntp.org"
]
----
<1> `vsphere_datastore`: The datastore to use.
<2> `vsphere_datastore_cluster`: The datastore_cluster to use.
