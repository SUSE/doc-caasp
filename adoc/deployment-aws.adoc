...
For user who does not have permission to create IAM role, role policy, and instance profile using terraform, devops should create them for you using instruction below:
