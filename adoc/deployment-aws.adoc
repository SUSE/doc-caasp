...
The last step before deploying is to provide the credentials
as environment variables that Terraform will automatically retrieve:
...
can be found in link:https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-regions-availability-zones.html#concepts-available-regions)[the official AWS documentation].
