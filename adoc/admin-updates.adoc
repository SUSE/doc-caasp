...
It may happen that the control plane is out of date. In this case, you would get something like this:
...
----
. Create a temporary lock on the {kube} component system packages:
+
----
