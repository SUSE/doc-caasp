...
[NOTE]
====
This section is about updating kubernetes to the next minor version, for example from 1.16 to 1.17. Minor updates require special plan and apply procedures,
being that the reason why they are handled by skuba.

For patch updates, for example for updating from 1.16.1 to 1.16.2 or 1.16.1.-1 to 1.16.1-2, see linkto:_base_os_updates[Base OS Update].
