...
To get an overview of the addon updates available with validating the addon base and patches manifest before applied to the current cluster, you can run:
