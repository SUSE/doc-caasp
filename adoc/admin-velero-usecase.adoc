...
Use schedule backup to perform the the periodical backup. When the {kube} cluster runs into an unexpected state, recover from the most recent schedule backup.
