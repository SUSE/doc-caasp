...
+
Please ref to <<addon_certificates_rotation>> on how to use cert-manager and reloader to issue `oidc-dex` and `oidc-gangway` certificate signed by trusted CA certificate/key.
