...
include::common_loggins.adoc[Logging,leveloffset=+2]
...
[NOTE]
====
Due to a naming convention conflict, all Versions of {productname} 4.x will be released in the `4.0` module.
====
