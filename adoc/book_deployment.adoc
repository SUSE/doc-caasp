...
refer to: link:{docurl}single-html/caasp-airgap/[].
...
include::deployment-updates.adoc[Cluster Updates,leveloffset=+1]

== Upgrading {productname}

include::deployment-migration.adoc[Migration from {productname} 4.2, leveloffset=+1]
