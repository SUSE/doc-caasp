...
===== Grow or Shrink replica number

One method is to grow or shrink the number of overall replicas being created by a service.
...
. Grow or shrink deployment replica size before node joining.
+
[NOTE]
====
