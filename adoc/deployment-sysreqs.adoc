...
[IMPORTANT]
====
It is vital that the management workstation runs an NTP server and that time synchronization is configured to the same NTP servers,
which you will use later to synchronize the cluster nodes.
====
