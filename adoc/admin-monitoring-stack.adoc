...
+
For more information on how to configure alerts, refer to: https://prometheus.io/docs/alerting/notification_examples/[Prometheus: Alerting - Notification Template Examples]
+
----
serverFiles:
  alerts: {}
...
==== Alertmanager Configuration Example
Refer to <<alertmanager_configuration_example, subdomains' installation>>
...
==== Adding Grafana Dashboards
Refer to <<adding_grafana_dashboards, subdomains' installation>>
