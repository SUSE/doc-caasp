...
|image:logo_kubernetes.png[Kubernetes,width=200,height=70]
|link:https://kubernetes.io/[]
^|*{kube_version}*

|image:logo_crio.svg[CRI-O,width=200,height=70]
|link:https://cri-o.io/[]
^|*{crio_version}*

|image:logo_cilium.png[Cilium,width=200,height=70]
|link:https://cilium.io[]
^|*{cilium_version}*

|image:logo_etcd.svg[etcd,width=200,height=70]
|link:https://github.com/etcd-io/etcd[]
^|*{etcd_version}*

|image:logo_dex.png[dex,width=200,height=70]
|link:https://github.com/dexidp/dex[]
^|*{dex_version}*

|image:logo_kured.png[Kured,width=80,height=70] Kured
...
suitable for productive use and has no fault tolerance whatsoever.
