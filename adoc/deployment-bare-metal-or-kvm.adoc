...
Refer to the official {ay} documentation for more information: link:https://documentation.suse.com/sles/15-SP2/single-html/SLES-autoyast/#book-autoyast[{ay} Guide].
====
...
.. `<timezone>`
+
Adjust the timezone your nodes will be set to. Refer to: link:https://documentation.suse.com/sles/15-SP2/single-html/SLES-autoyast/#id-1.7.5.13.6[{sls} {ay} Guide: Country Settings]
...
Install {sls} {base_os_version} from your preferred medium and follow the steps for link:https://documentation.suse.com/sles/15-SP2/single-html/SLES-autoyast/#invoking-autoinst[Invoking the Auto-Installation Process]
...
link:https://documentation.suse.com/sles/15-SP2/single-html/SLES-rmt/#cha-rmt-client[RMT Guide]
====
...
Please refer to: link:{docurl}html/caasp-admin/_miscellaneous.html#_configuring_httphttps_proxy_for_cri_o[]
