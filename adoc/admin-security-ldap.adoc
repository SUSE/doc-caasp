...
Example LDIF configuration to create user `user-regular1` through LDAP command:
====
...
Example LDIF configuration to create user `user-regular2` through LDAP command:
====
...
Example LDIF configuration to create user `user-admin` through LDAP command:
====
...
Example LDIF configuration to create group `k8s-users` through LDAP command:
====
...
Example LDIF configuration to create group `k8s-admins` through LDAP command:
====
...
Example LDIF configuration to create user `user-bind` through LDAP command:
====
