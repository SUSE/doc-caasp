...
. Execute `docker` command to deploy 389 Directory Server. This will start non-TLS (389) and TLS (636) protocols together with automatically self-signed cert and key.
+
----
docker run -d \
	-p 389:389 \
