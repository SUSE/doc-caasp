...
If you need to find an IP address later on, you can run `terraform output` within the directory you performed the deployment from the `~/my-cluster` directory or perform the following steps:
