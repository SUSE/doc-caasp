...
* After skuba 4.2.2:
+
If you have configured kustomize dex patch, please update your kustomize dex patch to use `secretEnv: OIDC_GANGWAY_CLIENT_SECRET`, then Dex & Gangway will use the same client secret stored in gangway Secret, which is
+
from
+
----
