...
[NOTE]
====
For more information on the audit log and its contents, see: https://v1-11.docs.kubernetes.io/docs/tasks/debug-application-cluster/audit/[Kubernetes
...
Policy::
The YAML file defining the https://v1-11.docs.kubernetes.io/docs/tasks/debug-application-cluster/audit/#audit-policy[auditing
policy rules]
