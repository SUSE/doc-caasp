...
For production environments, we recommend the use of link:https://documentation.suse.com/sle-ha/15-SP2/[{sle} {hasi} 15]
====
...
[WARNING]
====
`HAProxy` is available as a supported package with a link:https://documentation.suse.com/sle-ha/15-SP2/[{sle} {hasi} 15] subscription.
