...
.. `<suse_register>`
+
Insert the email address and {productname} product key in the placeholder fields. This activates {sle} 15 SP1.
.. `<addon>`
+
Insert the {productname} product key in the placeholder field. This enables the {productname} extension module.
