...
Refer to the official {ay} documentation for more information:
link:https://www.suse.com/documentation/sles-15/singlehtml/book_autoyast/book_autoyast.html[{ay}
Guide].
+
 `<ntp-client>`::
