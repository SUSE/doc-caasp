...
[TIP]
If you do not wish to use infrastructure load balancers, please deploy additional machines and refer to xref:loadbalancer[].
...
Once the machines have been installed using the {ay} file, you are now ready proceed with xref:bootstrap[].
