...
This step needs to be performed on a machine where Helm is installed and configured in the {productname} cluster.
For steps to install Helm, refer to link:{docurl}html/caasp-admin/_software_management.html#helm-install[].
